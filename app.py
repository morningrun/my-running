...
# 화이트 톤 배경 & 마스코트 대폭 확대 및 얼굴 중심 정렬 스타일 CSS
st.markdown("""
    <style>
    ...
    * {
    ...
    /* 동그라미 프레임 고정, 안쪽 마스코트 극대화 및 얼굴 중앙 배치 */
    .mascot-frame {
        width: 75px;
        height: 75px;
        border-radius: 50%;
    ...
    .mascot-zoomed-img {
        ...
        height: 600%;
        object-fit: cover;
        object-position: 50% 15%; /* 얼굴 부위가 프레임 정중앙에 오도록 상하 위치 조정 */
    }
